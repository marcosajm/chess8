...
// include: /tmp/tmpqauguzap.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = './public/main.data';
    ...
    async function runWithFS(Module) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_./public/main.data');
      }
      Module['addRunDependency']('datafile_./public/main.data');
    ...
    loadPackage({"files": [{"filename": "/nnue.bin", "start": 0, "end": 873988}, {"filename": "/nnue2.bin", "start": 873988, "end": 1747976}, {"filename": "/nnue3.bin", "start": 1747976, "end": 2621964}, {"filename": "/nnue4.bin", "start": 2621964, "end": 3495952}, {"filename": "/nnue5.bin", "start": 3495952, "end": 4369940}, {"filename": "/nnue6.bin", "start": 4369940, "end": 5243928}, {"filename": "/nnue7.bin", "start": 5243928, "end": 6117916}, {"filename": "/nnue8.bin", "start": 6117916, "end": 6991904}, {"filename": "/nnue9.bin", "start": 6991904, "end": 7865892}], "remote_package_size": 7865892});

  })();

// end include: /tmp/tmpqauguzap.js
// include: /tmp/tmppi2j31h0.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmppi2j31h0.js
// include: /tmp/tmpqgaxotzf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpqgaxotzf.js
...
var _find_ai_move_wasm = Module['_find_ai_move_wasm'] = makeInvalidEarlyAccess('_find_ai_move_wasm');
var _promote_pawn_wasm = Module['_promote_pawn_wasm'] = makeInvalidEarlyAccess('_promote_pawn_wasm');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['find_ai_move_wasm'] != 'undefined', 'missing Wasm export: find_ai_move_wasm');
  assert(typeof wasmExports['promote_pawn_wasm'] != 'undefined', 'missing Wasm export: promote_pawn_wasm');
  ...
  _find_ai_move_wasm = Module['_find_ai_move_wasm'] = createExportWrapper('find_ai_move_wasm', wasmExports['find_ai_move_wasm'], 1);
  _promote_pawn_wasm = Module['_promote_pawn_wasm'] = createExportWrapper('promote_pawn_wasm', wasmExports['promote_pawn_wasm'], 2);
...
if (typeof exports === 'object' && typeof module === 'object') {
  ...
  module.exports.default = ChessModule;
