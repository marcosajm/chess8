...
class Config:
    ...
    BATCH_SIZE = 2048  
    LEARNING_RATE = 0.0006  # Adjusted for stability
    EPOCHS = 148               # Decreased to prevent severe overfitting
    VALIDATION_SPLIT = 0.15  
    WEIGHT_DECAY = 2e-3        # Kept high to act as strong regularization
    GRADIENT_CLIP = 1.0  
    PATIENCE = 36              # Quicker early stopping for small data
    DROPOUT_RATE = 0.25        # Slightly higher dropout to fight memorization
    
    # EPOCH-BASED EMA CONFIGURATION
    EMA_DECAY = 0.80   
    EMA_WARMUP_EPOCHS = 2   # new: ramp decay from 0.9 -> 0.999 over first 5 epochs
