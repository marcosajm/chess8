...
class Config:
    ...
    GRADIENT_CLIP = 1.0  # Lower than 1.0 for stability
    PATIENCE = 40  # Early stopping patience
    DROPOUT_RATE = 0.20  # Lower dropout for smaller dataset
    EMA_DECAY = 0.999
    EMA_WARMUP_EPOCHS = 5   # new: ramp decay from 0.9 -> 0.999 over first 5 epochs
