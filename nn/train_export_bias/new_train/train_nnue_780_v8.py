...
class Config:
    ...
    # Training parameters - OPTIMIZED FOR 40k POSITIONS
    BATCH_SIZE = 2048  # Smaller batch for better generalization
    LEARNING_RATE = 0.0018  # Start here, use cosine annealing or reduce on plateau
    EPOCHS = 500  # More epochs needed with lower LR
    VALIDATION_SPLIT = 0.11  # Slightly more validation data
    WEIGHT_DECAY = 1e-5  # Reduced from 1e-4 to prevent underfitting
    GRADIENT_CLIP = 0.9  # Lower than 1.0 for stability
    PATIENCE = 80  # Early stopping patience
    DROPOUT_RATE = 0.10  # Lower dropout for smaller dataset
    ...
    # Seed optimization
    SEED_SEARCH_RANGE = 50  # Number of random seeds to test
...
# ============== Dataset ==============NEW BEST: seed 456795 12211, 974079, 418284,753300 226721, 326580, 969737 270823, 976779 810523 213729 727452 658732 419356 898647 521159 99177 901702 145783 777845 391302(best)
...
def find_best_seed():
    ...
    dataset = NNUE_Dataset(Config.DATA_FILE, seed=19, shuffle=True)
